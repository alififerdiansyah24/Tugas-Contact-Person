...
<div class="container">
    <div class="d-flex justify-content-between topbar py-2">
        <div class="d-flex align-items-center flex-shrink-0 topbar-info">
            <a href="#" class="me-4 text-secondary"><i class="fas fa-map-marker-alt me-2 text-dark"></i>Tulungagung, Jawa Timur</a>
            <a href="#" class="me-4 text-secondary"><i class="fas fa-phone-alt me-2 text-dark"></i>088217206039</a>
            <a href="#" class="text-secondary"><i class="fas fa-envelope me-2 text-dark"></i>alifi240700@gmail.com</a>
        </div>
            ...
            <div class="search-form">
                <form method="GET">
                    <div class="form-group">
                        <div class="d-flex">
                            <input type="text" name="keyword" class="form-control border-0 rounded-pill" placeholder="Search Here" required=""/>
